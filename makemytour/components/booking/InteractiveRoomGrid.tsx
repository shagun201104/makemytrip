...
const ROOM_OPTIONS: HotelRoomOption[] = [
  ...
  },
  {
    ...
    name: "Super Deluxe Garden View Room",
    badge: "Recommended Upgrade",
    upsellTag: "Extra Space & Garden View",
    extraPricePerNight: 1500,
    sizeSqFt: 420,
    bedType: "King Bed",
    features: ["Private Garden View Balcony", "Extra Sofa Bed & Lounge", "Espresso Coffee Machine", "Bathtub & Luxury Toiletries"],
    availableCount: 3,
    images: [
      "https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=800&q=80",
    ],
    preview3DColor: "#10b981",
  },
  {
    ...
    extraPricePerNight: 3500,
    sizeSqFt: 580,
    bedType: "King Bed",
    features: ["Separate Living Area & Workstation", "Private Balcony with Ocean View", "Marble Bathroom & Soaking Tub", "Executive Lounge & Cocktails"],
    availableCount: 2,
    images: [
  ...
  },
  {
    ...
    name: "Presidential Suite & Plunge Pool Villa",
    badge: "Ultimate Luxury",
    upsellTag: "VIP Concierge & Butler Included",
    extraPricePerNight: 7500,
    sizeSqFt: 980,
    bedType: "Super King Bed",
    features: ["Private Heated Plunge Pool", "24/7 Personal Butler Service", "Private Terrace & Jacuzzi", "Luxury Airport Transfers Included"],
    availableCount: 1,
    images: [
